...
def train_net(data, model, loss_func, optimizer, batch_size, max_epochs,
	...
	for epoch in xrange(max_epochs):
		...
		if val_acc > opt_val_acc:
			...
			#############################################################################
			cur_params = dict()
			cur_params["fc1_w"] = model.net.get_params("fc1_w")
			cur_params["fc1_b"] = model.net.get_params("fc1_b")
			cur_params["fc2_w"] = model.net.get_params("fc2_w")
			cur_params["fc2_b"] = model.net.get_params("fc2_b")
